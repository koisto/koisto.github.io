...
```
After running these commands we see that mitch can run Vim with root priveleges. After refering to https://gtfobins.github.io/ I found out how this can be exploited.
